...
----------------------------------------*/
  ...
  new Swiper( '.swiper-container', {
    speed: 400,
    width: 600,//（設定するとレスポンシブ機能はなくなる）
    loop: true,
    loopedSlides: 6,//ループ時にslidesPerView： ‘auto’の場合クローンの数を指定
    spaceBetween: 40,
    pagination: {
      el: '.swiper-pagination',
      type: 'bullets',//“bullets”, “fraction”, “progressbar”,”custom”から選べる。
...
// form validation
    (function() {
      ...
      function setSubmitProp() {
        if( requireFlg && privacyFlg ) {//エラーないなら
